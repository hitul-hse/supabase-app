# Graph Report - supabase-app  (2026-09-01)
...
- SSO Providers
- Time Org Chart View
- Management People Allowlist
- Order Findings Overlap
- Order Names vs Workbook
- Stale Entry
- Unlawful TT Links
- Drop Netflix Demo
...
- Check Profile Person Link
- Check Project Write Auth
- Check Reassignment Migration
- Check Reassignment Migration Needed
- Check Records Tabs UI
- Check Redirect Guard Logic
- Check Responsibility Encodings
- Check Time Live Ready
- Check Time Page Data
- Check Verify Policies Query
- Check View Fix Impact
- Diagnose Deploy Migration Order
- Diagnose Order Name Conflict
- Diagnose Self Replacement
- Agent Prompt Evals
- Fix Projects Gate Alias
- Generate Apply Modules
- Issue Test Login Link
- Link Profiles to People
- Measure Page Density
- Prove OAuth Invite Linking
- Provider Access
- Recheck Economics Access
- Record Demo Video
- Shot This Year
...
- Audit Tables
- Audit View Consumers
- Check CI Workflow
- Check Management People Rendered
- Check Masterdata Source Migration
- Check Modules RLS
- Check No Anonymous Read
- Check Prod Config
- Check RLS Behaviour
- Check Sync Freshness
- Check Views Admit Unknown
- Diagnose My Work Permission
- Diagnose Project Detail Bridge
- Diagnose Reassignment Capability
- Diagnose Reassignment Propagation
- Diagnose Stefan Identity
- Diagnose Whose My Work
- Grade Backend Agent
- Grade Testing Agent
- Reports Module
- Patch Source
- Measure Table Scroll
- Normalise Member Teams
- Probe Live RLS
- Verify Anon Write
...
### Community 1 - "Project Management"
Cohesion: 0.01
...
### Community 41 - "Entity Resolution"
Cohesion: 0.07
...
### Community 45 - "Design Guidelines"
Cohesion: 0.08
...
### Community 56 - "Customer Master Foundation"
Cohesion: 0.21
...
### Community 87 - "Audit Runtime Errors"
Cohesion: 0.12
...
### Community 96 - "Project Risks Model"
Cohesion: 0.12
...
### Community 97 - "Module Depth Research"
Cohesion: 0.12
...
### Community 98 - "Factorial Identity Baseline"
Cohesion: 0.15
...
### Community 105 - "User Profile Design"
Cohesion: 0.12
...
### Community 108 - "Overview Filters"
Cohesion: 0.12
...
### Community 118 - "Identity Linking"
Cohesion: 0.13
...
### Community 124 - "Discovery Tracking Time"
Cohesion: 0.14
...
### Community 126 - "Customer Portfolio Excel Mapping"
Cohesion: 0.14
...
### Community 133 - "Analytics Core Schema"
Cohesion: 0.15
...
### Community 134 - "Contract Periods Check"
Cohesion: 0.15
...
### Community 145 - "User Profile Implementation"
Cohesion: 0.17
...
### Community 150 - "Profile RLS Check"
Cohesion: 0.17
...
### Community 165 - "Platform Architecture"
Cohesion: 0.18
...
### Community 166 - "Factorial API Integration"
Cohesion: 0.18
...
### Community 172 - "Entry Policy Equivalence"
Cohesion: 0.18
Nodes (7): after, before, ROLES, schemaSrc, shippedMatch, text, wide

### Community 173 - "Profile Actions"
Cohesion: 0.20
...
### Community 181 - "Factorial Hours Comparison"
Cohesion: 0.20
...
### Community 182 - "Machine Transfer"
Cohesion: 0.20
...
### Community 184 - "Approval Error Handling"
Cohesion: 0.20
...
### Community 186 - "Customer Master Foundation"
Cohesion: 0.20
Nodes (5): cols, foundation, legalFields, schema, stgPolicies

### Community 187 - "Invite Throttle Classification"
Cohesion: 0.24
...
### Community 199 - "BillableRatePanel.tsx"
Cohesion: 0.38
...
### Community 204 - "Audit App Quality"
Cohesion: 0.22
...
### Community 206 - "Duration Parsing"
Cohesion: 0.39
Nodes (6): check(), eq(), fmt(), rejects, formatDuration(), parseDuration()

### Community 207 - "Factorial Identity Migration"
Cohesion: 0.28
...
### Community 226 - "Order Name Corruption"
Cohesion: 0.25
...
### Community 308 - "Add Work Permission"
Cohesion: 0.33
Nodes (5): block, keys, m, out, src

### Community 309 - "Apply View Privilege Fix"
Cohesion: 0.33
...
### Community 340 - "Recheck Economics Access"
Cohesion: 0.33
Nodes (4): admin, anon, env, execClient

### Community 341 - "Record Demo Video"
Cohesion: 0.33
Nodes (4): OUT_DIR, Scene, SCENES, SCREENSHOTS_DIR

### Community 342 - "Shot This Year"
Cohesion: 0.33
Nodes (4): admin, anon, app, env

### Community 343 - "Verify Migrations Applied"
Cohesion: 0.33
Nodes (4): byKey, db, NEEDED, timeDb

### Community 344 - "Verify Policy Gate Fails"
Cohesion: 0.33
...
### Community 349 - "Layered Architecture"
Cohesion: 0.40
...
### Community 352 - "Pagination Contract"
Cohesion: 0.40
Nodes (5): 3.1 Parameters, 3.2 Response envelope, 3.3 A correct paging loop, 3.4 SDK alternative, 3. Pagination contract

### Community 353 - "Add Team Analysis Note"
Cohesion: 0.40
Nodes (4): closeAt, gaugeAt, lines, src

### Community 355 - "Audit Permission Drift"
Cohesion: 0.40
Nodes (4): c, env, grantedKeys, MISSING

### Community 356 - "Audit Tables"
Cohesion: 0.40
Nodes (3): files, rows, tableFiles

### Community 357 - "Audit View Consumers"
Cohesion: 0.40
Nodes (3): c, env, files

### Community 359 - "Check Management People Rendered"
Cohesion: 0.40
Nodes (4): env, EXPECTED, failures, idx

### Community 360 - "Check Masterdata Source Migration"
Cohesion: 0.40
Nodes (3): db, paste, sql

### Community 361 - "Check Modules RLS"
Cohesion: 0.50
Nodes (3): as(), byCmd, modulesFor()

### Community 362 - "Check No Anonymous Read"
Cohesion: 0.40
Nodes (3): c, ENV, REPO

### Community 363 - "Check Prod Config"
Cohesion: 0.40
Nodes (4): env, refs, scripts, unique

### Community 365 - "Check Sync Freshness"
Cohesion: 0.40
Nodes (4): env, headers, hours, lastOk

### Community 366 - "Check Views Admit Unknown"
Cohesion: 0.40
Nodes (3): c, ENV, REPO

### Community 367 - "Diagnose My Work Permission"
Cohesion: 0.40
Nodes (3): keys, mods, perms

### Community 368 - "Diagnose Project Detail Bridge"
Cohesion: 0.40
Nodes (3): c, env, touches

### Community 369 - "Diagnose Reassignment Capability"
Cohesion: 0.40
Nodes (3): c, env, ADR-0001

### Community 371 - "Diagnose Stefan Identity"
Cohesion: 0.40
Nodes (3): c, env, ADR-0001

### Community 372 - "Diagnose Whose My Work"
Cohesion: 0.50
Nodes (4): book(), c, env, q()

### Community 373 - "Grade Backend Agent"
Cohesion: 0.40
Nodes (3): control, KEY, treatment

### Community 374 - "Grade Testing Agent"
Cohesion: 0.40
Nodes (4): control, KEY, missedByControl, treatment

### Community 375 - "Reports Module"
Cohesion: 0.60
Nodes (4): app_user_role_v2(), can_view_report(), people, reports

### Community 376 - "Patch Source"
Cohesion: 0.60
Nodes (3): insertImport(), patchFile(), readNormalised()

### Community 377 - "Measure Table Scroll"
Cohesion: 0.40
Nodes (4): env, results, routes, worst

### Community 378 - "Normalise Member Teams"
Cohesion: 0.40
Nodes (4): CANONICAL, client, folded, keys

### Community 380 - "Verify Anon Write"
Cohesion: 0.40
Nodes (3): after, env, rows

### Community 381 - "Verify Chart Notes Render"
Cohesion: 0.40
Nodes (3): byRoute, env, EXPECT

### Community 383 - "Webhooks vs Polling"
Cohesion: 0.50
...
### Community 385 - "Apply and Verify View Fix"
Cohesion: 0.50
Nodes (3): c, env, sql
...
### Community 432 - "Traceability Run"
Cohesion: 0.50
Nodes (3): needsServer, REQUIREMENTS, results

### Community 437 - "Provider Status Route"
Cohesion: 0.67
Nodes (3): classify(), GET(), PROVIDERS

### Community 439 - "Factorial Identity Review"
Cohesion: 0.50
...
### Community 448 - "Grant Extra"
Cohesion: 0.67
Nodes (3): grantExtra, grantMissing, pair()

### Community 454 - "Contrast"
Cohesion: 0.67
