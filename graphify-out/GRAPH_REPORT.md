# Graph Report - health-portal  (2026-09-02)

## Corpus Check
- 758 files · ~1,330,646 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6431 nodes · 9331 edges · 581 communities (460 shown, 121 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 132 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `30398e38`
...
- check-shared-mailbox-pattern.mjs
...
1. `scripts` - 212 edges
2. `createClient()` - 108 edges
3. `Card()` - 48 edges
4. `secondsToHours()` - 46 edges
5. `Database` - 30 edges
6. `PERMISSIONS` - 29 edges
7. `CardHeader()` - 28 edges
8. `requirePermission()` - 27 edges
9. `loadEnv()` - 26 edges
10. `PageHeader()` - 26 edges
...
## Communities (581 total, 121 thin omitted)

### Community 0 - "scripts"
Cohesion: 0.01
Nodes (212): scripts, apply-modules, apply:my-work-module, apply:project-policy-hoisting, asana:backlog, build, check:acceptance, check:action-auth (+204 more)
...
Cohesion: 0.06
Nodes (48): ApprovalResult, approveLeaveRequestAction(), cancelLeaveRequest(), rejectLeaveRequestAction(), requestLeave(), RequestLeaveState, setLeaveRequestStatus(), MyLeavePanel() (+40 more)
...
Cohesion: 0.11
Nodes (45): AlertsPage(), toggleRolePermission(), AdminRolesPage(), dynamic, GalleryPage(), AdminUsersPage(), AdminUserDetailPage(), orNa() (+37 more)

### Community 5 - "check-health-score.mjs"
Cohesion: 0.05
Nodes (56): agree(), all, capped, check(), composeBad, composeGrid, dbOnlySecurity(), deadlocked (+48 more)

### Community 6 - "nav-icons.tsx"
Cohesion: 0.05
Nodes (27): metadata, PortalPage(), BrandMark(), BrandMarkProps, PIECES, MOBILE_TAB_HREFS, MobileTab, mobileTabsFor() (+19 more)

### Community 7 - "Mobile Shell"
Cohesion: 0.04
Nodes (43): alphas, bandGradient, bannedOnBar, barMin, baseSolid, bio, blurPx, CAPSULE_FILES (+35 more)

### Community 8 - "check-time-integration.mjs"
Cohesion: 0.04
Nodes (27): dir, require, dir, require, alias, anon, componentAlias, days (+19 more)

### Community 9 - "launch-chromium.mjs"
Cohesion: 0.05
Nodes (25): admin, anon, cookies, env, errors, env, EXPECTED, failures (+17 more)

### Community 10 - "Charts.tsx"
Cohesion: 0.06
Nodes (35): Gallery(), int, latency, runs(), OverviewHero(), getWeekDrilldown(), r1(), WeekDrilldown (+27 more)

### Community 11 - "ReportTables.tsx"
Cohesion: 0.10
Nodes (38): render(), translateList(), translateText(), CustomerDetail(), fmt(), ManagementCustomerPortfolio(), ManagementDataQuality(), fmt() (+30 more)

### Community 12 - "check-design-system.mjs"
Cohesion: 0.05
Nodes (43): APP_SHELL, authInput, authShell, buttonSrc, card, chartsSrc, check(), chrome (+35 more)

### Community 13 - "gate-env.mjs"
Cohesion: 0.06
Nodes (28): c, env, sql, env, page, querySrc, supabase, admin (+20 more)

### Community 14 - "dashboard/page.tsx"
Cohesion: 0.10
Nodes (36): BillableDonut(), hrs(), bucketRange(), BUCKETS, GROUPS, one(), TrackingTimeDashboardPage(), Option (+28 more)
...
### Community 17 - "management-customer-portfolio.ts"
Cohesion: 0.08
...
### Community 19 - "ManagementMatrix.tsx"
Cohesion: 0.08
Nodes (33): EmployeeOwnershipOverview(), fmt(), STATUS_KEY, TEXT_KEY, Translate, Drill, DrillRow, fmt() (+25 more)

### Community 20 - "overview-live.ts"
Cohesion: 0.10
Nodes (36): OverviewFilters(), PRESETS, buildTeamOptions(), burnTone(), countRows(), excludeFutureEntries(), fmtHours(), getBudgetPosture() (+28 more)
...
### Community 22 - "bridge-time-to-hub.mjs"
Cohesion: 0.06
Nodes (34): accepted, APPLY, badCode, byHub, c, custAgrees(), custMap, env (+26 more)

### Community 23 - "(app)/page.tsx"
Cohesion: 0.09
Nodes (30): InviteUserForm(), isoWeekNumber(), OverviewPage(), thursdayOf(), TeamLeadPage(), IconArrowRight(), IconWarning(), describeAge() (+22 more)

### Community 24 - "my-work.ts"
Cohesion: 0.10
Nodes (32): burnClass(), CustomerGroup(), hours(), MyWorkSummary(), burnClass(), hours(), MyWorkTables(), rank() (+24 more)

### Community 25 - "profile/page.tsx"
Cohesion: 0.13
Nodes (25): changePassword(), EXT, removeAvatar(), updateDisplayName(), updatePreferences(), uploadAvatar(), ALLOWED_AVATAR_TYPES, LANDING_PAGES (+17 more)

### Community 26 - "check-brand-mark.mjs"
Cohesion: 0.06
Nodes (28): AUTH, AUTH_C, authMarks, CSS, CSS_C, dAttrs, froms, heroIdx (+20 more)

### Community 27 - "apply-modules.sql"
Cohesion: 0.09
...
### Community 28 - "secondsToHours"
Cohesion: 0.11
Nodes (32): BurnChart(), ContributorTable(), h(), ProjectTotalsStrip(), ProjectTotalsTile, TaskTable(), allTimeFilters(), burndown() (+24 more)

### Community 29 - "ManagementCustomerPortfolio.tsx"
Cohesion: 0.11
Nodes (24): authorisedWriter(), CandidateLoadState, decideResponsibleChange(), loadReassignmentCandidates(), ManagementChangeActionState, requestResponsibleChange(), ageInDays(), ChangeRequestItem() (+16 more)

### Community 30 - "time-dashboard.ts"
Cohesion: 0.12
Nodes (28): CustomerTable(), EconomicsTable(), eur(), hrs(), MemberTable(), OrgTotalsStrip(), ProjectTable(), relativeDays() (+20 more)

### Community 31 - "system-health.ts"
Cohesion: 0.07
Nodes (31): slaFor(), APP_SCHEMAS, ConsumptionPanel, DbStats, DeployIdentity, EfficiencyPanel, EnvFlag, EXPECTED_HEADERS (+23 more)

### Community 32 - "audit-permission-catalogue.mjs"
Cohesion: 0.07
Nodes (27): atRisk, c, c2, codeKeys, danglingModule, declared, env, fc (+19 more)

### Community 33 - "check-vendor-parity.mjs"
Cohesion: 0.07
Nodes (26): admin, env, headers, isVendorRow(), localRows, localSeconds, missing, now (+18 more)

### Community 34 - "inventory.mjs"
Cohesion: 0.10
Nodes (25): empty, inv, md, records, secrets, buildInventory(), classify(), collectWarnings() (+17 more)

### Community 35 - "data-hygiene.ts"
Cohesion: 0.07
Nodes (22): by, CASES, ADR-0001, DataHygiene, FindingKind, getDataHygiene(), HygieneColumn, HygieneFinding (+14 more)

### Community 36 - "import-review/page.tsx"
Cohesion: 0.10
Nodes (24): CaseRow(), CustomerMasterImportReviewPage(), display(), dynamic, hrefFor(), Pager(), parseFilter(), priorityTone() (+16 more)

### Community 37 - "people-live.ts"
Cohesion: 0.11
Nodes (26): PeopleSection(), getOrgChart(), OrgChartData, OrgMember, OrgNode, SupabaseTyped, timeSchema(), EMPTY_DIRECTORY (+18 more)

### Community 38 - "TimesheetGrid.tsx"
Cohesion: 0.15
...
### Community 39 - "APPLY-IN-SQL-EDITOR-2.sql"
Cohesion: 0.17
...
Cohesion: 0.13
Nodes (21): AppLayout(), DesktopSidebarShell(), IconPanelCollapse(), IconPanelExpand(), getCardStyle(), getTargetRect(), OnboardingTour(), Rect (+13 more)

### Community 44 - "Entity Resolution Rules für den Customer Master"
Cohesion: 0.07
...
### Community 45 - "Management Dashboard V2 – Fachliche Spezifikation"
Cohesion: 0.07
...
### Community 46 - "check-budget-alerts.mjs"
Cohesion: 0.07
Nodes (19): ackRoles, actions, alertQueries, blockMap, byProject, cols, contracts, list (+11 more)

### Community 47 - "customer-master-import-review.ts"
Cohesion: 0.15
Nodes (26): buildCases(), caseKey(), caseName(), caseType(), CountRow, customerId(), customerNameFor(), documentedResolution() (+18 more)

### Community 48 - "HSE Hub — Design System"
Cohesion: 0.08
...
### Community 49 - "ENABLE-SSO-STEPS.md"
Cohesion: 0.08
...
### Community 50 - "HSE Operations Management Dashboard"
Cohesion: 0.08
...
### Community 51 - "recheck-dashboard-claims.mjs"
Cohesion: 0.08
Nodes (20): admin, corrected, distinctProjects, env, estimatedIds, gates, hasUnattributed, lastRef (+12 more)

### Community 52 - "ReportPanels.tsx"
Cohesion: 0.12
Nodes (21): BAND, CapacityPanel(), h(), DrillDatum, TimeTileDrillData, age(), dayLabel(), FreshnessBanner() (+13 more)

### Community 53 - "InsightPanels.tsx"
Cohesion: 0.10
Nodes (19): h(), InsightPanels(), SERIES, BumpSeries, DivergingBars(), DivergingItem, HeatCell, HeatmapMatrix() (+11 more)

### Community 54 - "import-masterdata-projects.mjs"
Cohesion: 0.09
Nodes (21): assignmentRows, byOrder, db, DRY, firstName(), ids, ADR-0001, newPeople (+13 more)

### Community 55 - "OrgChartView.tsx"
Cohesion: 0.15
Nodes (21): UserRow(), handleDelete(), handleResend(), handleRoleChange(), handleTeamChange(), handleToggleActive(), assertCanEditPeople(), OrgEditState (+13 more)

### Community 56 - "team-lead-live.ts"
Cohesion: 0.13
...
### Community 57 - "profile-actions.ts"
Cohesion: 0.17
Nodes (20): AdminActionResult, adminDeleteEntry(), adminUpdateEntry(), adminUpdateProfile(), adminUpdateWeeklyHours(), authorise(), Authorised, Refused (+12 more)

### Community 58 - "management-multi-service-matrix.ts"
Cohesion: 0.14
...
### Community 64 - "2. What is actually wrong"
Cohesion: 0.09
...
### Community 65 - "TopBarChrome.tsx"
Cohesion: 0.14
Nodes (12): Avatar(), setLocale(), LocaleSwitcher(), IconSearch(), IconButtonLink(), Segmented(), Locale, LOCALE_COOKIE (+4 more)

### Community 66 - "check-data-table-primitive.mjs"
Cohesion: 0.10
...
### Community 67 - "check-gates-ci-executable.mjs"
Cohesion: 0.12
Nodes (17): candidates, crashed, dir, files, fine, files, safe, unsafe (+9 more)

### Community 68 - "time/page.tsx"
Cohesion: 0.24
...
### Community 69 - "ADR-002: Customer Master Target Model and Import Architecture"
Cohesion: 0.10
...
### Community 92 - "audit-runtime-errors.mjs"
Cohesion: 0.12
Nodes (15): add(), benign, byKind, downloadDir, env, exercise(), findings, IGNORABLE (+7 more)

### Community 93 - "check-dashboard-tables.mjs"
Cohesion: 0.12
Nodes (15): app, cleanup(), customers, entries, members, monthStart, PROFILE, projects (+7 more)

### Community 94 - "check-management-data.mjs"
Cohesion: 0.17
Nodes (16): customerAgrees(), dangling, db, head(), ADR-0001, norm(), orderCustomers, orderIds (+8 more)

### Community 95 - "check-order-project-matching.mjs"
Cohesion: 0.11
Nodes (15): ambiguous, byName, c, collisions, env, failures, malformed, matched (+7 more)

### Community 96 - "check-overview-filters.mjs"
Cohesion: 0.11
Nodes (12): board, boardPresets, boardQueries, en, filters, filtersCode, minePresets, page (+4 more)

### Community 97 - "check-risk-panel-survives-nulls.mjs"
Cohesion: 0.11
Nodes (11): after, before, hasOverBudget, hasWithoutStatus, lapse, obAfter, obBefore, REPO (+3 more)

### Community 98 - "check-team-select.mjs"
Cohesion: 0.11
Nodes (14): actionsStub, dir, editable, legacyOptions, legacyRow, React, readOnly, readOnlyLegacy (+6 more)

### Community 99 - "check-trackingtime-parity.mjs"
Cohesion: 0.12
Nodes (13): admin, env, evSeconds(), extra, extraSeconds, headers, missing, missingSeconds (+5 more)

### Community 100 - "factorial-identity/page.tsx"
Cohesion: 0.25
Nodes (14): assertCanDecide(), createPersonAndLink(), DecisionState, excludeRow(), resolveToPerson(), MACHINE_STATUSES, withDb(), FactorialIdentityPage() (+6 more)

### Community 101 - "createAdminClient"
Cohesion: 0.28
Nodes (14): assertCanManageUsers(), changeUserDepartment(), changeUserRole(), deleteUser(), InviteState, inviteUser(), resendInvite(), roleHasPermission() (+6 more)

### Community 102 - "ProjectsExplorer.tsx"
Cohesion: 0.20
Nodes (14): CustomerMultiSelect(), h(), customerPortfolioFromRows(), CustomerPortfolioView, CustomerShareRow, EMPTY_PROJECT_FILTERS, filterProjectRows(), hasActiveProjectFilters() (+6 more)

### Community 103 - "Project Risk Resolution Actions"
Cohesion: 0.12
...
### Community 104 - "Project Risks Modell"
Cohesion: 0.12
...
### Community 105 - "Module depth: research findings and build order"
Cohesion: 0.12
...
### Community 109 - "system-health/page.tsx"
Cohesion: 0.18
Nodes (12): ageOf(), dynamic, first(), fmtInt(), FreshnessRow(), hoursSince(), nf, reasonOf() (+4 more)

### Community 110 - "Entscheidung"
Cohesion: 0.12
...
### Community 111 - "User profile section — design"
Cohesion: 0.12
...
### Community 112 - "check-adr001-rule-discriminates.mjs"
Cohesion: 0.21
Nodes (15): c, customerAgrees(), env, examples, gu, head(), isUnlawful(), ADR-0001 (+7 more)

### Community 113 - "check-factorial-join-viable.mjs"
Cohesion: 0.15
Nodes (13): ALLOWED, buckets, c, call(), env, fetchAll(), freqs, leakedKeys (+5 more)

### Community 114 - "check-no-mock-data.mjs"
Cohesion: 0.12
Nodes (8): dash, en, hse, live, MOCK_TABLES, page, REPORTING_FILES, syncBar

### Community 115 - "profile-admin.ts"
Cohesion: 0.22
Nodes (13): ADMIN_ENTRY_LIMIT, AdminEntryRow, AdminProfileView, countNominalWeeks(), findMember(), getAdminProfileView(), num(), readEntries() (+5 more)

### Community 116 - "check-server-action-auth.mjs"
Cohesion: 0.14
Nodes (11): app, authCookie, build, cleanup(), now, restoreTsconfig(), server, session (+3 more)

### Community 117 - "profile-dashboard-render.mjs"
Cohesion: 0.12
Nodes (14): breakdownRows, budgetAll, entryRowsShipped, env, filters, grouped, ids, points (+6 more)

### Community 118 - "proxiedOrigin"
Cohesion: 0.21
Nodes (11): GET(), safeNext(), classify(), GET(), PROVIDERS, config, proxy(), proxiedOrigin() (+3 more)

### Community 119 - "DemoPageV4.tsx"
Cohesion: 0.12
Nodes (6): EASE, FEATURES, NOTE: preload must stay "none". With preload="metadata" Chrome starts a, STACK, STATS, T

### Community 120 - "health-history.ts"
Cohesion: 0.16
Nodes (14): asSample(), defaultSamplesPath(), Growth, GROWTH_MIN_SPAN_HOURS, HealthHistory, HealthSample, HealthSampleNumericField, HealthSampleScores (+6 more)

### Community 121 - "management-service-overview.ts"
Cohesion: 0.17
...
### Community 122 - "HSE Hub — Data Model Documentation"
Cohesion: 0.13
Nodes (15): 10. Referential integrity, 13. What this schema deliberately does not do, 14. Glossary, 1. What this document is, 2. What the portal is, 3.1 Raw, 3.2 Staging, 3.3 Analytics (+7 more)

### Community 123 - "Responsibility and coverage: what was wrong, and what still needs a person"
Cohesion: 0.13
...
### Community 124 - "check-factorial-auth.mjs"
Cohesion: 0.13
Nodes (7): PROJECTS, readLog, supabase, env, failures, fileEnv, REQUIRED_SCOPES

### Community 125 - "check-broken-cover-live.mjs"
Cohesion: 0.13
Nodes (13): c, dir, firstSelf, { getBrokenCover }, KNOWN_MUTUAL, lastMutual, modFile, mutualIds (+5 more)

### Community 126 - "check-identity-linking.mjs"
Cohesion: 0.13
Nodes (11): anon, byEmail, detailed, env, forks, H, linkedUsers, mismatched (+3 more)

### Community 127 - "check-management-contract-hours-live.mjs"
Cohesion: 0.13
...
### Community 128 - "check-management-people-complete.mjs"
Cohesion: 0.18
Nodes (13): allowed, allowlist, block, c, dbNames, env, failures, listedWithoutResponsibility (+5 more)

### Community 129 - "check-my-work-scoping.mjs"
Cohesion: 0.13
Nodes (11): db, head, icons, mathias, migrationSql, nav, page, query (+3 more)

### Community 130 - "contract-periods.ts"
Cohesion: 0.21
Nodes (13): ContractWatchlist(), KIND_LABEL, tone(), ContractAttentionKind, ContractAttentionRow, EXPIRY_HORIZON_DAYS, getActiveContractPeriod(), getContractsNeedingAttention() (+5 more)

### Community 131 - "PeopleDirectory.tsx"
Cohesion: 0.23
Nodes (13): bandOf(), CAPACITY_BANDS, CapacityBand, initialsOf(), PeopleDirectory(), SortKey, sortPeople(), FilterChip() (+5 more)

### Community 132 - "TimeEntryList.tsx"
Cohesion: 0.18
Nodes (10): clock(), EntryRow(), formatDayHeading(), TimeEntryList(), TimeTotalsStrip(), WeekSummaryTable(), TimeEntryRow, TimeTotals (+2 more)

### Community 133 - "TrackingTime — discovery findings"
Cohesion: 0.14
...
### Community 135 - "check-factorial-harvest.mjs"
Cohesion: 0.14
Nodes (12): contradiction, env, future, kept, leaked, projected, sparse, SPEC_FIELDS (+4 more)

### Community 136 - "check-factorial-identity-baseline.mjs"
Cohesion: 0.15
Nodes (13): byEmail, c, claimedPersons, classify(), env, looksLikeMailbox, ADR-0001, mustBe() (+5 more)

### Community 137 - "check-reassignment-candidates-live.mjs"
Cohesion: 0.14
Nodes (10): c, dir, { getReassignmentCandidates }, nulls, onProject, require, serverOnly, summed (+2 more)

### Community 138 - "time-transform.ts"
Cohesion: 0.24
...
### Community 143 - "HSE Hub — Portal Architecture & Design"
Cohesion: 0.15
...
### Community 145 - "check-contract-periods.mjs"
Cohesion: 0.15
Nodes (7): budgetCol, del, migration, names, newP, oldP, schema

### Community 146 - "check-invite-oauth-model.mjs"
Cohesion: 0.15
Nodes (11): admin, byEmail, env, forked, invitedPending, multi, oauthLinked, profileIds (+3 more)

### Community 147 - "check-oauth-callback.mjs"
Cohesion: 0.17
Nodes (11): buttons, fn, hostile, iCall, iMissingCode, iProviderCheck, iSet, leaks (+3 more)

### Community 148 - "report-masterdata-responsibility.mjs"
Cohesion: 0.23
Nodes (11): APPLY, JSON_OUT, ADR-0001, connect(), loadEnv(), ADR-0001, norm(), num() (+3 more)

### Community 149 - "link-time-members.mjs"
Cohesion: 0.18
Nodes (11): APPLY, authUsers, db, ENV, memberEmails, norm(), personIdByUser, plan (+3 more)

### Community 150 - "broken-cover.ts"
Cohesion: 0.21
Nodes (10): BrokenCoverPanel(), kindKey, BrokenCoverKind, BrokenCoverProject, BrokenCoverSummary, findProjectWhere(), getBrokenCover(), isMutual() (+2 more)

### Community 151 - "ProjectsLedger.tsx"
Cohesion: 0.24
Nodes (10): getProjectHoursDrilldown(), ProjectHoursDrilldown, ProjectHoursRest, ProjectHoursRow, burnColor(), Facet, h(), LedgerSort (+2 more)

### Community 152 - "TeamLeadBoard.tsx"
Cohesion: 0.32
...
### Community 153 - "video/page.tsx"
Cohesion: 0.17
Nodes (7): CONNECTORS, Feature, FEATURES, Stat, StatCard(), STATS, useCountUp()

### Community 154 - "management-data-quality.ts"
Cohesion: 0.22
...
### Community 155 - "pg.d.ts"
Cohesion: 0.15
Nodes (6): Client, pg, Pool, PoolConfig, QueryResult, QueryResultRow

### Community 156 - "Task for the V3Code agent — HSE Hub data connectivity"
Cohesion: 0.17
...
### Community 157 - "System Health redesign — design brief"
Cohesion: 0.17
...
### Community 159 - "HSE Hub — Product Context"
Cohesion: 0.17
...
### Community 172 - "sandbox-seed.mjs"
Cohesion: 0.20
Nodes (10): between(), CUSTOMERS, db, entryRows, env, MEMBERS, pick(), projectRows (+2 more)

### Community 173 - "verify-identity-links.mjs"
Cohesion: 0.17
Nodes (8): blind, c, env, INSPECT, now, POLICY, rows, SAVE

### Community 174 - "TaskBoardView.tsx"
Cohesion: 0.27
Nodes (8): createTask(), AddTaskForm(), AddSectionForm(), TaskBoardView(), TasksSection(), BoardParent, ProjectSectionRow, TaskWithSubtasks

### Community 175 - "Contract periods, budget warnings, and renewals — design spec"
Cohesion: 0.18
...
### Community 177 - "Schema Conventions & Design Decisions"
Cohesion: 0.18
...
### Community 178 - "HSE Platform — Bridge Portal & Module Architecture"
Cohesion: 0.18
...
### Community 179 - "Factorial HR API — integration reference for the HSE platform"
Cohesion: 0.18
...
### Community 180 - "Management Dashboard – Übergabe und Restarbeiten"
Cohesion: 0.18
...
### Community 181 - "HSE Hub becomes the real system of record — design"
Cohesion: 0.18
...
### Community 198 - "Supabase schema & procedures"
Cohesion: 0.20
...
### Community 199 - "Factorial ↔ TrackingTime hours comparison — measured findings"
Cohesion: 0.20
...
### Community 200 - "Moving this project to a new PC"
Cohesion: 0.20
...
### Community 201 - "check-agent-references.cjs"
Cohesion: 0.20
Nodes (6): allFiles, fs, path, pkg, results, total

### Community 202 - "check-approval-error-handling.cjs"
Cohesion: 0.20
Nodes (8): actions, actionsPath, all, board, boardPath, checks, fs, path

### Community 203 - "check-contract-ui.mjs"
Cohesion: 0.20
Nodes (7): actions, exported, migration, page, panel, perms, queries

### Community 204 - "check-customer-master-foundation.mjs"
Cohesion: 0.20
Nodes (5): cols, foundation, legalFields, schema, stgPolicies

### Community 205 - "check-invite-throttle-classification.mjs"
Cohesion: 0.24
...
### Community 207 - "check-my-work-survives-nulls.mjs"
Cohesion: 0.20
Nodes (7): allMeasured, cg, partial, q, REPO, rows, summed

### Community 208 - "check-org-chart.mjs"
Cohesion: 0.20
Nodes (4): dir, mod, peopleStub, req

### Community 209 - "check-reimport-is-safe.mjs"
Cohesion: 0.20
Nodes (8): block, c, doc, env, omitted, populated, src, written

### Community 210 - "check-schema-executes.mjs"
Cohesion: 0.20
Nodes (8): expectedFns, expectedTables, got, gotFns, missingFns, missingTables, sql, upd

### Community 211 - "check-sync-schedule-alive.mjs"
Cohesion: 0.22
Nodes (7): c, env, gaps, isScheduled(), manual, scheduled, sinceLast

### Community 212 - "check-table-scroll-budget.mjs"
Cohesion: 0.20
Nodes (7): env, ENV_PATH, MOBILE, MOBILE_ROUTE_BUDGETS, REPO, ROUTE_BUDGETS, ROUTES

### Community 213 - "check-time-write-path.mjs"
Cohesion: 0.20
Nodes (5): ACTIONS, here, PAGE, root, TRACKER

### Community 214 - "diagnose-absence-vs-responsibility.mjs"
Cohesion: 0.22
Nodes (9): absentToday, c, call(), emailByEmployee, env, fetchAll(), ADR-0001, today (+1 more)

### Community 215 - "provision-members.mjs"
Cohesion: 0.20
Nodes (9): admin, APPLY, eligible, env, INVITE, profiledUserIds, ROLE_MAP, skipped (+1 more)

### Community 216 - "factorial-hours.ts"
Cohesion: 0.24
Nodes (8): FactorialUnavailableError, FactorialHoursReport, getFactorialHoursReport(), norm(), PersonComparison, r1(), SupabaseTyped, ADR-0001

### Community 217 - "Google and Microsoft sign-in"
Cohesion: 0.22
...
### Community 228 - "check-schema-order.cjs"
Cohesion: 0.22
Nodes (8): assertions, definedFunctions, definedTables, fs, knownFnNames, lines, problems, sql

### Community 229 - "check-sso-providers.mjs"
Cohesion: 0.25
Nodes (7): anon, env, get(), needed, probe(), siteUrl, url

### Community 230 - "check-time-org-chart-view.mjs"
Cohesion: 0.22
Nodes (7): executable, FORBIDDEN, leaked, migration, missing, names, REQUIRED

### Community 231 - "diagnose-management-people-allowlist.mjs"
Cohesion: 0.28
Nodes (8): allowed, ALLOWLIST, c, dbNames, env, excluded, norm(), phantom

### Community 232 - "diagnose-order-findings-overlap.mjs"
Cohesion: 0.22
Nodes (8): c, env, inBoth, MINE_AMBIGUOUS, MY_UNMATCHABLE_CUSTOMERS, onlyMine, onlySloth, slothIds

### Community 233 - "diagnose-order-names-vs-workbook.mjs"
Cohesion: 0.25
Nodes (8): byOrder, c, env, norm(), skipped, SUSPECT, wb, words()

### Community 234 - "diagnose-stale-entry.mjs"
Cohesion: 0.22
Nodes (7): admin, byId, env, ours, stale, ttIds, year

### Community 235 - "diagnose-unlawful-tt-links.mjs"
Cohesion: 0.28
Nodes (6): bad, c, env, lawful(), ADR-0001, norm()

### Community 236 - "drop-netflix-demo.mjs"
Cohesion: 0.22
Nodes (7): backup, c, c2, chunks, cols, env, migration

### Community 237 - "link-tt-to-hub-projects.mjs"
Cohesion: 0.22
Nodes (6): db, DRY, hubByName, links, ADR-0001, timeDb

### Community 238 - "recheck-agent-claim.cjs"
Cohesion: 0.22
Nodes (6): { execFileSync }, files, fs, graders, rerunExists, untested

### Community 239 - "refresh-order-hours.mjs"
Cohesion: 0.22
Nodes (7): AS_OF, db, DRY, orderByTT, previews, sums, timeDb

### Community 240 - "RolePermissionMatrix.tsx"
Cohesion: 0.25
Nodes (7): PermissionToggle(), handleToggle(), Props, WHY: the hand-rolled matrix rendered all 37 permissions unpaged, with no, Role, RolePermissionMatrix(), AppPermission

### Community 242 - "drill-data.ts"
Cohesion: 0.47
Nodes (8): Acc, add(), customerDrillData, NO_CUSTOMER_LABEL, projectKey(), projectsByMember(), ranked(), tileDrillData()

### Community 243 - "factorial/client.ts"
Cohesion: 0.39
Nodes (8): dataOf(), FactorialPerson, FactorialPresence, FactorialTeam, fetchFactorialPeople(), fetchFactorialPresence(), fetchFactorialTeams(), get()

### Community 244 - "app_user_profile"
Cohesion: 0.22
...
### Community 245 - "Review: feature/customer-dashboard-development (Bjoern, 27 commits, +6,330)"
Cohesion: 0.25
...
### Community 246 - "Task for V3Code — the long-scroll table problem (2026-08-24 ~18:50Z)"
Cohesion: 0.25
...
### Community 247 - "Going live with a module schema"
Cohesion: 0.25
...
### Community 248 - "6. THE IDENTITY PROBLEM"
Cohesion: 0.25
...
### Community 249 - "The eight mis-named orders are a spreadsheet problem, not an import bug"
Cohesion: 0.25
...
### Community 250 - "The sandbox workflow: experiment freely, merge deliberately"
Cohesion: 0.25
...
### Community 251 - "add-overview-chart-notes.mjs"
Cohesion: 0.25
Nodes (7): billableNote, gaugeAt, gaugeNote, idxBillable, idxGauge, lines, src

### Community 252 - "audit-data-inefficiencies.mjs"
Cohesion: 0.25
Nodes (6): broke, c, clean, env, findings, live

### Community 253 - "audit-pipeline.mjs"
Cohesion: 0.29
...
### Community 286 - "public.project_change_event"
Cohesion: 0.39
Nodes (5): public.project_change_event, public.project_change_request, auth.users, public.people, public.projects

### Community 287 - "Installed agent toolkits: gstack, everything-claude-code, graphify"
Cohesion: 0.29
...
### Community 288 - "12. Open questions and assumptions"
Cohesion: 0.29
...
### Community 291 - "Live TrackingTime members vs the mockup `people` table"
Cohesion: 0.29
...
### Community 292 - "check-apply-modules.mjs"
Cohesion: 0.29
Nodes (5): committed, cut, publicOnly, regenerated, schema

### Community 293 - "check-auth-gates.mjs"
Cohesion: 0.29
Nodes (4): middleware, publicRoutes, publicRoutesBlock, routes

### Community 294 - "check-content-width.mjs"
Cohesion: 0.29
Nodes (4): appFiles, css, shellUsers, stragglers

### Community 295 - "check-data-hygiene-disclosure.mjs"
Cohesion: 0.33
Nodes (3): env, mintLink(), openPage()

### Community 296 - "check-data-hygiene-gate-discriminates.mjs"
Cohesion: 0.29
Nodes (5): FIXTURE_GATES, GATES, liveSkips, MUTATIONS, TS

### Community 297 - "check-live-dashboard.mjs"
Cohesion: 0.29
Nodes (4): admin, anonClient, app, env

### Community 298 - "check-my-work-browser-flow.mjs"
Cohesion: 0.29
Nodes (4): env, jar, needles, roleWords

### Community 299 - "check-people-and-filters-ui.mjs"
Cohesion: 0.29
Nodes (5): admin, anon, cookies, env, errors

### Community 300 - "check-records-tabs.mjs"
Cohesion: 0.29
Nodes (4): dashSrc, sheetsSrc, tabsSrc, timeSrc

### Community 301 - "check-redirect-allowlist.mjs"
Cohesion: 0.29
Nodes (5): cases, env, failures, SITE, URL_BASE

### Community 302 - "check-team-analysis-ui.mjs"
Cohesion: 0.38
Nodes (5): admin, cookiesFor(), env, pageText(), wait()

### Community 303 - "check-theme-and-figures.mjs"
Cohesion: 0.29
Nodes (5): admin, anon, cookies, env, errors

### Community 305 - "diagnose-factorial-contract-hours.mjs"
Cohesion: 0.29
Nodes (4): candidateFields, env, rows, weekly

### Community 306 - "diagnose-factorial-credential-shape.mjs"
Cohesion: 0.29
Nodes (3): env, keys, ownerish

### Community 307 - "diagnose-google-error.mjs"
Cohesion: 0.29
Nodes (6): env, g, googleUrl, SIGNS, state, text

### Community 308 - "measure-latency-variance.mjs"
Cohesion: 0.29
Nodes (4): admin, anon, app, env

### Community 309 - "promote-customer-master.mjs"
Cohesion: 0.29
Nodes (4): client, DRY, env, ADR-0001

### Community 310 - "prove-view-gate-catches-bug.mjs"
Cohesion: 0.29
Nodes (5): bad, c, env, FIXED, good

### Community 311 - "report-customer-matching.mjs"
Cohesion: 0.43
Nodes (6): env, LEGAL_FORMS, main(), makeClient(), normName(), stripLegalForm()

### Community 312 - "run-all-gates.mjs"
Cohesion: 0.29
Nodes (5): broken, idx, names, pkg, results

### Community 313 - "verify-magic-link-flow.mjs"
Cohesion: 0.29
Nodes (5): env, H, hasCode, hasHashTokens, token

### Community 314 - "BillableRatePanel.tsx"
Cohesion: 0.38
Nodes (5): setBillableRate(), SetBillableRateResult, BillableRatePanel(), handleSubmit(), BillableValueRow

### Community 315 - "ThemeToggle.tsx"
Cohesion: 0.43
Nodes (4): getServerSnapshot(), getSnapshot(), subscribe(), ThemeToggle()

### Community 316 - "APPLY-THESE-MIGRATIONS.md"
Cohesion: 0.33
...
### Community 317 - "7. Layer 3 — Identity resolution"
Cohesion: 0.33
...
### Community 318 - "1. Authentication"
Cohesion: 0.33
...
### Community 319 - "2. Versioning and base URLs"
Cohesion: 0.33
...
### Community 320 - "7. What Factorial gives us that TrackingTime cannot"
Cohesion: 0.33
...
### Community 321 - "9. Proposed schema"
Cohesion: 0.33
...
### Community 322 - "UI conventions: long lists, tables, and review queues"
Cohesion: 0.33
...
### Community 323 - "public.project_budget_status"
Cohesion: 0.47
...
### Community 324 - "add-my-work-permission.mjs"
Cohesion: 0.33
Nodes (5): block, keys, m, out, src

### Community 325 - "apply-view-privilege-fix.mjs"
Cohesion: 0.33
Nodes (4): before, c, env, VIEWS

### Community 326 - "audit-live-db.mjs"
Cohesion: 0.33
Nodes (4): counts, env, findings, rest()

### Community 327 - "audit-perf-and-permissions.mjs"
Cohesion: 0.33
Nodes (3): c, env, MISSING

### Community 328 - "check-feature-reachable.mjs"
Cohesion: 0.33
Nodes (4): linkCandidates, linkedFrom, pickerCandidates, pickerFile

### Community 329 - "check-hr-role-migration.mjs"
Cohesion: 0.33
Nodes (4): execKeys, hrKeys, migration, names

### Community 330 - "check-new-gates-can-fail.mjs"
Cohesion: 0.53
Nodes (5): check(), ADR-0001, provesItCatches(), run(), sha()

### Community 333 - "check-profile-person-link.mjs"
Cohesion: 0.33
Nodes (4): c, env, KNOWN_TEST_ACCOUNTS, SEED_MOCKUPS

### Community 336 - "check-reassignment-migration-is-needed.mjs"
Cohesion: 0.33
Nodes (3): fnBodies, original, REPO

### Community 337 - "check-time-live-ready.mjs"
Cohesion: 0.33
Nodes (3): env, headers, url

### Community 338 - "check-time-page-data.mjs"
Cohesion: 0.33
Nodes (4): dashboardRepair, hrefRepair, schemaSql, utilisation

### Community 339 - "check-verify-policies-query.mjs"
Cohesion: 0.40
Nodes (4): byFix, query, run(), schema

### Community 340 - "check-view-fix-impact.mjs"
Cohesion: 0.33
Nodes (4): c, env, files, seen

### Community 341 - "diagnose-deploy-migration-order.mjs"
Cohesion: 0.33
Nodes (4): c, env, hits, notNull

### Community 342 - "diagnose-null-assignments.mjs"
Cohesion: 0.33
Nodes (5): env, get(), nameToProjects, nulls, personName

### Community 343 - "diagnose-order-name-customer-conflict.mjs"
Cohesion: 0.33
Nodes (4): c, conflicts, env, stop

### Community 344 - "diagnose-self-replacement.mjs"
Cohesion: 0.33
Nodes (4): byPerson, c, env, examples

### Community 345 - "Agent prompt evals"
Cohesion: 0.33
Nodes (5): Agent prompt evals, Honest limits, Method, Results, What each result actually shows

### Community 346 - "fix-projects-gate-alias.mjs"
Cohesion: 0.33
Nodes (5): buttonAt, closeAt, explorerAt, lines, src

### Community 347 - "generate-apply-modules.mjs"
Cohesion: 0.33
Nodes (5): beforeStart, body, out, schema, startMarker

### Community 348 - "issue-test-login-link.mjs"
Cohesion: 0.33
Nodes (4): env, next, IMPORTANT: point the human straight at our own /auth/callback with, target

### Community 349 - "link-profiles-to-people.mjs"
Cohesion: 0.33
Nodes (5): db, LINKS, ADR-0001, peopleIds, timeDb

### Community 350 - "measure-page-density.mjs"
Cohesion: 0.33
Nodes (3): env, jar, routes

### Community 351 - "prove-oauth-invite-linking.mjs"
Cohesion: 0.33
Nodes (4): admin, created, env, stamp

### Community 352 - "Provider access probes"
Cohesion: 0.33
...
### Community 367 - "playwright"
Cohesion: 0.40
Nodes (3): admin, anon, env

### Community 368 - "add-team-analysis-note.mjs"
Cohesion: 0.40
Nodes (4): closeAt, gaugeAt, lines, src

### Community 370 - "audit-permission-drift.mjs"
Cohesion: 0.40
Nodes (4): c, env, grantedKeys, MISSING

### Community 371 - "audit-tables.mjs"
Cohesion: 0.40
Nodes (3): files, rows, tableFiles

### Community 372 - "audit-view-consumers.mjs"
Cohesion: 0.40
Nodes (3): c, env, files

### Community 374 - "check-masterdata-source-migration.mjs"
Cohesion: 0.40
Nodes (3): db, paste, sql

### Community 375 - "check-modules-rls.mjs"
Cohesion: 0.50
Nodes (3): as(), byCmd, modulesFor()

### Community 376 - "check-no-anonymous-read.mjs"
Cohesion: 0.40
Nodes (3): c, ENV, REPO

### Community 378 - "check-prod-config.mjs"
Cohesion: 0.40
Nodes (4): env, refs, scripts, unique

### Community 380 - "check-sync-freshness.mjs"
Cohesion: 0.40
Nodes (4): env, headers, hours, lastOk

### Community 381 - "check-views-admit-unknown.mjs"
Cohesion: 0.40
Nodes (3): c, ENV, REPO

### Community 382 - "diagnose-my-work-permission.mjs"
Cohesion: 0.40
Nodes (3): keys, mods, perms

### Community 383 - "diagnose-project-detail-bridge.mjs"
Cohesion: 0.40
Nodes (3): c, env, touches

### Community 384 - "diagnose-reassignment-capability.mjs"
Cohesion: 0.40
Nodes (3): c, env, ADR-0001

### Community 386 - "diagnose-stefan-identity.mjs"
Cohesion: 0.40
Nodes (3): c, env, ADR-0001

### Community 387 - "diagnose-whose-my-work.mjs"
Cohesion: 0.50
Nodes (4): book(), c, env, q()

### Community 388 - "grade-backend-agent.cjs"
Cohesion: 0.40
Nodes (3): control, KEY, treatment

### Community 389 - "grade-testing-agent.cjs"
Cohesion: 0.40
Nodes (4): control, KEY, missedByControl, treatment

### Community 390 - "reports-module.sql"
Cohesion: 0.60
Nodes (4): app_user_role_v2(), can_view_report(), people, reports

### Community 391 - "patch-source.mjs"
Cohesion: 0.60
Nodes (3): insertImport(), patchFile(), readNormalised()

### Community 392 - "measure-table-scroll.mjs"
Cohesion: 0.40
Nodes (4): env, results, routes, worst

### Community 393 - "normalise-member-teams.mjs"
Cohesion: 0.40
Nodes (4): CANONICAL, client, folded, keys

### Community 395 - "verify-anon-write.mjs"
Cohesion: 0.40
Nodes (3): after, env, rows

### Community 396 - "verify-chart-notes-render.mjs"
Cohesion: 0.40
Nodes (3): byRoute, env, EXPECT

### Community 398 - "BudgetPanel.tsx"
Cohesion: 0.50
Nodes (3): BudgetPanel(), euro(), ProjectBudgetStatusRow

### Community 399 - "4. Conventions"
Cohesion: 0.50
Nodes (4): 4. Conventions, Naming, The rule that matters most, Types

### Community 400 - "8. Webhooks vs polling"
Cohesion: 0.50
...
### Community 402 - "apply-and-verify-view-fix.mjs"
Cohesion: 0.50
Nodes (3): c, env, sql

### Community 426 - "diagnose-blind-accounts.mjs"
Cohesion: 0.50
Nodes (3): blind, c, env

### Community 440 - "grade-frontend-agent.cjs"
Cohesion: 0.50
Nodes (3): control, KEY, treatment

### Community 441 - "fix-permission-gate-regex.mjs"
Cohesion: 0.50
Nodes (3): note, out, src

### Community 442 - "export-machine-state.ps1"
Cohesion: 0.83
Nodes (3): Add-Result(), Copy-One(), Copy-Tree()

### Community 444 - "purge-probe-accounts.mjs"
Cohesion: 0.50
Nodes (3): APPLY, env, RFC-2606

### Community 445 - "revert-deliberate-bypasses.mjs"
Cohesion: 0.50
Nodes (3): c, env, seen

### Community 449 - "traceability-run.mjs"
Cohesion: 0.50
Nodes (3): needsServer, REQUIREMENTS, results

### Community 454 - "getCustomerMasterImportReview"
Cohesion: 0.50
Nodes (4): getCustomerMasterImportReview(), getPool(), isBillingOnlyRecord(), matchesFilter()

### Community 455 - "crm.factorial_identity_review"
Cohesion: 0.50
Nodes (3): crm.factorial_identity_review, auth.users, public.people

### Community 457 - "time.member_utilisation"
Cohesion: 0.50
Nodes (3): time.entry, time.member, time.member_utilisation

### Community 458 - "Agent task template"
Cohesion: 0.50
Nodes (3): Agent task template, Routing, Worked example

### Community 460 - "time.project"
Cohesion: 0.67
...
## Knowledge Gaps
- **3198 isolated node(s):** `supabase`, `public.netflix_users`, `platform.health_sample`, `eslintConfig`, `withNextIntl` (+3193 more)
...
- **Why does `label()` connect `label` to `check-dashboard-acceptance.mjs`, `check-sso-providers.mjs`, `check-oauth-success-path-live.mjs`, `check-time-integration.mjs`, `check-table-scroll-budget.mjs`, `measure-latency-variance.mjs`, `import-masterdata-projects.mjs`, `check-time-acceptance.mjs`, `audit-runtime-errors.mjs`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `Database` connect `database.types.ts` to `contract-periods.ts`, `createClient`, `dashboard/page.tsx`, `types.ts`, `AuthShell.tsx`, `management-customer-portfolio.ts`, `ManagementMatrix.tsx`, `overview-live.ts`, `broken-cover.ts`, `management-data-quality.ts`, `secondsToHours`, `ManagementCustomerPortfolio.tsx`, `time-dashboard.ts`, `data-hygiene.ts`, `people-live.ts`, `team-lead-live.ts`, `management-multi-service-matrix.ts`, `management-project-risks.ts`, `time/page.tsx`, `budget-alerts.ts`, `factorial-hours.ts`, `createAdminClient`, `profile-admin.ts`, `management-service-overview.ts`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `loadEnv()` connect `gate-env.mjs` to `check-management-people-complete.mjs`, `check-replacement-coverage.mjs`, `check-factorial-harvest.mjs`, `check-data-hygiene-disclosure.mjs`, `launch-chromium.mjs`, `check-factorial-identity-baseline.mjs`, `check-people-and-filters-ui.mjs`, `check-projects-admit-unmeasured.mjs`, `check-team-analysis-ui.mjs`, `check-theme-and-figures.mjs`, `check-adr001-rule-discriminates.mjs`, `sync-factorial-identity.mjs`, `check-order-hours-freshness.mjs`, `check-factorial-auth.mjs`, `check-order-project-matching.mjs`?**
