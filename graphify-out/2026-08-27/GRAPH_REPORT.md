# Graph Report - Supabase  (2026-08-27)

## Corpus Check
- 692 files · ~1,234,003 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5680 nodes · 8043 edges · 536 communities (407 shown, 129 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 107 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5314a2a3`
...
## Communities (536 total, 129 thin omitted)

### Community 0 - "scripts"
Cohesion: 0.01
Nodes (200): scripts, apply-modules, apply:my-work-module, apply:project-policy-hoisting, asana:backlog, build, check:acceptance, check:action-auth (+192 more)
...
### Community 3 - "import-trackingtime.mjs"
Cohesion: 0.17
...
### Community 14 - "time-transform.ts"
Cohesion: 0.24
...
### Community 18 - "formatSeconds"
Cohesion: 0.32
Nodes (5): TimeTotalsStrip(), WeekSummaryTable(), TimeTotals, WeekSummaryRow, formatSeconds()

### Community 19 - "Card.tsx"
Cohesion: 0.06
Nodes (52): ContractWatchlist(), KIND_LABEL, tone(), EmployeeOwnershipOverview(), fmt(), dynamic, KIND_STYLE, runtime (+44 more)

### Community 20 - "profile/actions.ts"
Cohesion: 0.23
Nodes (14): EXT, removeAvatar(), updateDisplayName(), updatePreferences(), uploadAvatar(), ALLOWED_AVATAR_TYPES, LANDING_PAGES, LOCALES (+6 more)
...
Cohesion: 0.21
Nodes (22): parseScopeParam(), parseViewParam(), parseWeekParam(), TimePage(), TimeTracker(), currentTimeWeek(), dayBounds(), EntryJoinRow (+14 more)
...
Cohesion: 0.14
Nodes (23): check(), eq(), fmt(), rejects, AddEntryState, addTimesheetEntry(), copyLastWeek(), currentPersonId() (+15 more)
...
### Community 41 - "check-my-work-scoping.mjs"
Cohesion: 0.13
...
Cohesion: 0.09
Nodes (33): fmt(), ManagementMatrix(), Segmented(), ALL_SERVICES, ANNUAL_PLAN_HOURS, canonicalService(), emptyCells(), getManagementContractHours() (+25 more)
...
### Community 51 - "createAdminClient"
Cohesion: 0.15
...
### Community 79 - "PeopleDirectory.tsx"
Cohesion: 0.10
Nodes (33): assertCanEditPeople(), OrgEditState, setMemberDetails(), setSupervisor(), timeSchema(), wouldCreateCycle(), initialsOf(), NodeRow() (+25 more)
...
Cohesion: 0.08
Nodes (67): AlertsPage(), toggleRolePermission(), AdminRolesPage(), AdminUsersPage(), ManagementPage(), DataHygienePage(), LeavePage(), metadata (+59 more)
...
Cohesion: 0.08
Nodes (39): render(), PermissionToggle(), handleToggle(), Props, WHY: the hand-rolled matrix rendered all 37 permissions unpaged, with no, Role, RolePermissionMatrix(), ManagementDataQuality() (+31 more)
...
### Community 203 - "TimeEntryList.tsx"
Cohesion: 0.38
Nodes (5): clock(), EntryRow(), formatDayHeading(), TimeEntryList(), TimeEntryRow
...
Cohesion: 0.12
Nodes (25): fmt(), labelOf(), ManagementMultiServiceMatrix(), missingText(), WHY: 84 customer rows rendered in one unpaged block made ?tab=customers 17.7, aggregateHours(), canonicalService(), CLOSED_STATUSES (+17 more)
...
Cohesion: 0.10
Nodes (37): BillableDonut(), hrs(), bucketRange(), BUCKETS, GROUPS, one(), TrackingTimeDashboardPage(), Option (+29 more)
...
### Community 252 - "database.types.ts"
Cohesion: 0.10
...
### Community 254 - "budget-alerts.ts"
Cohesion: 0.07
Nodes (31): env, page, querySrc, supabase, acknowledgeAlert(), AlertActionResult, AlertCard(), AlertList() (+23 more)
...
Cohesion: 0.13
Nodes (30): authorise(), Authorised, ContractActionResult, correctContractPeriod(), explain(), hours(), isoDate(), percent() (+22 more)
...
Cohesion: 0.10
Nodes (28): authorisedWriter(), CandidateLoadState, decideResponsibleChange(), loadReassignmentCandidates(), ManagementChangeActionState, requestResponsibleChange(), ageInDays(), ChangeRequestItem() (+20 more)
...
Cohesion: 0.09
Nodes (24): BAND, CapacityPanel(), h(), h(), InsightPanels(), SERIES, BumpSeries, DivergingBars() (+16 more)
...
### Community 409 - "TimeViewTabs.tsx"
Cohesion: 0.47
...
### Community 426 - "time-dashboard.ts"
Cohesion: 0.12
...
Cohesion: 0.06
Nodes (53): CustomerMultiSelect(), h(), BurnDonutRow(), h(), PortfolioCharts(), customerPortfolioFromRows(), CustomerPortfolioView, CustomerShareRow (+45 more)
...
### Community 483 - "[userId]/page.tsx"
Cohesion: 0.15
Nodes (22): AdminActionResult, adminDeleteEntry(), adminUpdateEntry(), adminUpdateProfile(), adminUpdateWeeklyHours(), authorise(), Authorised, Refused (+14 more)

### Community 485 - "check-team-select.mjs"
Cohesion: 0.12
...
### Community 489 - "people-live.ts"
Cohesion: 0.16
Nodes (18): getOrgChart(), OrgMember, OrgNode, SupabaseTyped, timeSchema(), getAssignments(), getLivePeople(), getMemberMeta() (+10 more)
...
Cohesion: 0.27
Nodes (7): ADR-0001, check(), provesItCatches(), run(), sha(), c, env
...
Cohesion: 0.22
Nodes (6): allMeasured, cg, partial, q, rows, summed
...
### Community 509 - "types.ts"
Cohesion: 0.04
Nodes (65): requestLeave(), MyLeavePanel(), setBillableRate(), SetBillableRateResult, BillableRatePanel(), handleSubmit(), addComment(), addSubtask() (+57 more)

### Community 510 - "profile.ts"
Cohesion: 0.27
Nodes (8): AppLayout(), effectiveNameOf(), getProfileView(), loadProfileView(), ProfileView, getSignedInUser(), oncePerRequest(), slot

### Community 511 - "StatusBadge.tsx"
Cohesion: 0.40
...
### Community 515 - "check-table-scroll-budget.mjs"
Cohesion: 0.25
Nodes (5): env, MOBILE, MOBILE_ROUTE_BUDGETS, ROUTE_BUDGETS, ROUTES
...
### Community 525 - "management-service-overview.ts"
Cohesion: 0.17
...
### Community 531 - "measure-latency-variance.mjs"
Cohesion: 0.29
Nodes (4): admin, anon, app, env
...
### Community 533 - "TeamLeadBoard.tsx"
Cohesion: 0.16
Nodes (18): ApprovalResult, approveAllPending(), approveDecision(), approveTimesheetWeek(), rejectTimesheetWeek(), requireApprover(), setTimesheetWeekStatus(), PendingTimesheetApprovals() (+10 more)

### Community 534 - "Sidebar.tsx"
Cohesion: 0.14
Nodes (15): metadata, PortalPage(), BrandMark(), BrandMarkProps, PIECES, LogoutButton(), MobileSidebarDrawer(), MobileSidebarProps (+7 more)

### Community 535 - "profile-admin.ts"
Cohesion: 0.23
Nodes (13): ADMIN_ENTRY_LIMIT, AdminMemberLink, AdminProfileTarget, AdminProfileView, findMember(), getAdminProfileView(), NOMINAL_WEEKLY_HOURS, num() (+5 more)

### Community 540 - "SecurityCard.tsx"
Cohesion: 0.31
Nodes (6): changePassword(), IDLE, SecurityCard(), PasswordStrengthBar(), getPasswordStrength(), MIN_PASSWORD_LENGTH

## Knowledge Gaps
- **2809 isolated node(s):** `env`, `BoardCellStatus`, `BoardWeek`, `MonthComparison`, `MonthDelta` (+2804 more)
...
- **Why does `Database` connect `database.types.ts` to `team-lead-live.ts`, `management-service-overview.ts`, `contract-actions.ts`, `profile-admin.ts`, `time/page.tsx`, `overview-live.ts`, `time-dashboard.ts`, `management-project-risks.ts`, `ManagementMatrix.tsx`, `ManagementCustomerPortfolio.tsx`, `createAdminClient`, `projects-live.ts`, `AuthShell.tsx`, `management-customer-portfolio.ts`, `management-multi-service-matrix.ts`, `createClient`, `dashboard/page.tsx`, `people-live.ts`, `management-data-quality.ts`, `types.ts`, `budget-alerts.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `createClient()` connect `createClient` to `(app)/layout.tsx`, `contract-actions.ts`, `Card.tsx`, `profile/actions.ts`, `TeamLeadBoard.tsx`, `Sidebar.tsx`, `time/actions.ts`, `leave/actions.ts`, `time/page.tsx`, `SecurityCard.tsx`, `TimesheetGrid.tsx`, `ManagementCustomerPortfolio.tsx`, `createAdminClient`, `PeopleDirectory.tsx`, `dashboard/page.tsx`, `[userId]/page.tsx`, `budget-alerts.ts`, `types.ts`, `profile.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
...
- **What connects `env`, `BoardCellStatus`, `BoardWeek` to the rest of the system?**
