      ...
      <ul className="flex items-stretch gap-0.5 p-1.5">
            ...
            */
            <li key={tab.href} className={active ? "min-w-0 flex-1" : "flex-none"}>
              <Link
                ...
                */
                className={`flex min-h-[44px] items-center justify-center gap-2 rounded-full px-3 control-motion active:scale-[0.97] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)] ${
                  active
        ...
        <li className={moreActive ? "min-w-0 flex-1" : "flex-none"}>
          <button
            ...
            className={`flex min-h-[44px] w-full items-center justify-center gap-2 rounded-full px-3 control-motion active:scale-[0.97] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)] ${
              moreActive
                ? "bg-[var(--accent-hover)] text-[var(--accent-contrast)]"
                : "text-[var(--glass-text)]"
            }`}
