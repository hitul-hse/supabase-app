...
function VideoPlayer() {
  ...
  // Controls stay visible whenever playback is paused. Derived from `playing`
  // rather than synchronised into state by an effect: setState inside an effect
  // costs an extra render on every play/pause and is what
